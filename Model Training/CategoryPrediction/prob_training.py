    ...
    if problemOrCategoryWise == problemOrCategoryKeys['category']:
        ...
        for classifier in mlAlgos:
            ...
            for category in categories:
                ...
                if modelNumber == 1:
                    generateLazyLoad(useIntegrate, category, platform, uniqueFileConvention, tempDataFileConv,
                                     test_size = test_size,
        ...
        for classifier in mlAlgos:
            if modelNumber == 1:
                ...
                classifierMetricsMap[classifier] = get_accuracy(categories, classifier, uniqueFileConvention,
                                                                dataFileConvention,
