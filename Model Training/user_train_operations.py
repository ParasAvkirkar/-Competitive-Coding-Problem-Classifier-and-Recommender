...
def get_categorywise_difficulty_limits(uniqueFileConvention, platform, days_to_consider_pro_user):
    ...
    # Handle error where threshold for greedy, medium difficulty is not set
    if 'medium' not in categorywise_difficulty_limits['greedy']:
        print("threshold for greedy, medium difficulty is not set")
        categorywise_difficulty_limits['greedy']['medium'] = 5
