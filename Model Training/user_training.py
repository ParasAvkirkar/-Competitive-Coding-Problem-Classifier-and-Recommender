...
from user_train_operations import process_users, get_categorywise_difficulty_limits
...
if __name__ == '__main__':
    ...
    get_categorywise_difficulty_limits(uniqueFileConvention, PlatformType.Codechef, probCodeToObjects, probCodeToDifficulty, days_to_consider_pro_user = 730)
